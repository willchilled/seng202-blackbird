...
public class Filter {
    ...
    public static ArrayList<DataPoint> getAllPoints(DataTypes type) {
        ...
        switch (type) {
            ...
            case AIRPORTPOINT:
                ...
                ArrayList<DataPoint> myAirportPoints = DatabaseInterface.performGenericQuery(sql, type);
        ...
        return DatabaseInterface.performGenericQuery(sql, type);
    }
    ...
    static ArrayList<DataPoint> filterSelections(ArrayList<String> menusPressed, String searchString, DataTypes type) {
        ...
        switch (type) {
            ...
            case ROUTEPOINT:
                ...
                return DatabaseInterface.performGenericQuery(myQuery, type);
            case FLIGHT:
        ...
        filtered = DatabaseInterface.performGenericQuery(myQuery, type);
        return filtered;
    }
    ...
    protected static ArrayList<String> filterDistinct(String column, String table) {
        ...
        ArrayList<String> menuItems = DatabaseInterface.performDistinctQuery(sql);
    ...
    static DataPoint findAirportPointForDistance(String airportToCalc) {
        ...
        return DatabaseInterface.performGenericQuery(sql, DataTypes.AIRPORTPOINT).get(0);
    }
