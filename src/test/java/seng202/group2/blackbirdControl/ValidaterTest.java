...
/**
 * Created by wmu16 on 22/09/16.
 */
public class ValidaterTest extends TestCase {
    public void testCheckAirline() throws Exception {
        ...
        assertTrue(Validater.checkAirline(attributes));

        iata = "11111";
        attributes = new String[] {id, name, alias, iata, icao, callsign, country, active};
        assertFalse(Validater.checkAirline(attributes));
    ...
    public void testCheckAirport() throws Exception {
        ...
        assertTrue(Validater.checkAirport(attributes));

        lat = "9999999";
        attributes = new String[] {id, name, city, country, iata, icao, lat, lon, alt, timeZone, dst, tz};
        assertFalse(Validater.checkAirport(attributes));
